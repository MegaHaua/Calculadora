...
entrada = Entry(calculo, font = ("arial",20,"bold"), bg="powder blue", bd=30, width=28,justify=RIGHT)
...
#botoes calc simples 
btnlimpar = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.limpar, text = chr(67), bg="powder blue").grid(row = 1, column=0,pady=1)

btnlimptudo = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.limpar_tudo, text = chr(67)+ chr(69), bg="powder blue").grid(row = 1, column=1,pady=1)

btnraiz = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.raiz, text = "√", bg="powder blue").grid(row = 1, column=2,pady=1)

btnsoma = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.operação("+"), text = "+", bg="powder blue").grid(row = 1, column=3,pady=1)

btnsubt = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.operação("-"), text = "-", bg="powder blue").grid(row = 2, column=3,pady=2)

btnmult = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.operação("*"), text = "x", bg="powder blue").grid(row = 3, column=3,pady=3)

btndiv = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.operação("/"), text = ":", bg="powder blue").grid(row = 4, column=3,pady=4)

btnpocent = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda:valor_adicionado.operação("%"),  text = "%", bg="powder blue").grid(row = 5, column=0,pady=1)

btnzero = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.num_entrada(0), text = "0").grid(row = 5, column=1,pady=1) # nao sei se funcionaria dessa forma

btnponto = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=lambda: valor_adicionado.num_entrada(","), text = ".", bg="powder blue").grid(row = 5, column=2,pady=1)

btnigual = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.somatório, text = "=", bg="powder blue").grid(row = 5, column=3,pady=1)
...
btnpi = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.pi, text = "π", bg="powder blue").grid(row = 1, column=4,pady=1)

btnsen = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.seno, text = "sen", bg="powder blue").grid(row = 2, column=4,pady=1)

btncos = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.cos, text = "cos", bg="powder blue").grid(row = 3, column=4,pady=1)

btntg = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.tan, text = "tg", bg="powder blue").grid(row = 4, column=4,pady=1)

btne = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.euler, text = "e", bg="powder blue").grid(row = 5, column=4,pady=1)

btnlog = Button(calculo, width=6, height=2, font=("arial", 20, "bold"), bd=4, command=valor_adicionado.log, text = "log", bg="powder blue").grid(row = 1, column=5,pady=1)
